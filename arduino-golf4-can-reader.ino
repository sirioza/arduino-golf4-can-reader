...
FISLib LCD(FIS_WRITE_ENA, FIS_WRITE_CLK, FIS_WRITE_DATA);
...
void loop() {
  ...
  switch (position) {
    case 0:
      ...
      if (smallStringCount >= 10000/REFRESH_CLUSTER_TIME){
        smallStringCount = 0;
        position++;
      }
      break;
    ...
    case 6:
      ...
      break;
    default:
      FIS_WRITE_line1 = "UNDEFINED SCREEN";
      FIS_WRITE_line2 = "        ";
  }

  LCD.showText(FIS_WRITE_line1, FIS_WRITE_line2, smallStringCount);  
}